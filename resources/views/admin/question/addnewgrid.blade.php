<div id="questionadd-modal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
            ...
            <form role="form" id="qedit-form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="question_dimension" id="dimension" class="form-control">
                        </div>
                    </div>

                    @for ($i=1; $i < 6; $i++) <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="hidden" name="qqcount" value="5" id="qqcount">

                        </div>
                        @if($i!= 1)
                        <div class="col-sm-1"><a href="javascript:void(0);" class="btn btn-danger btn-addq"
                                type="button"> <span class="glyphicon glyphicon-minus"></span> </a></div>
                        @endif
                </div>
                    ...
                    <div class="controls col-sm-12">
                        <div class="field_wrapper">
                            <div class="col-sm-6 no-right-pad"><input class="form-control shrink" name="option_weight[]"
                                    value="{{$option_weight}}" type="text" /> </div>
        ...
        <div class="form-group no-margin">
            <div class="controls col-sm-6 col-sm-offset-6">
                <div class="field_wrapper">
                    <div class="no-left-pad"><input class="form-control shrink" name="fields[]" type="text" /></div>
                </div>
            </div>
        </div>
        <div class="form-group no-margin">
