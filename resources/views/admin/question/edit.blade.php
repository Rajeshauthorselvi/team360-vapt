...
@foreach($questions as  $key=>$question)
 <div id="questionedit-modal" class="modal fade" role="dialog">
                   ...
                   <div class="col-sm-9">
                  {{Form::text('question_dimension',$question->question_dimension,['class'=>'form-control'])}}
                   </div></div>

                   <div class="form-group">
                   <label class="col-sm-3">Question @if($question->question_required==1)<span class="qtn-required">*</span>@endif </label> 
                   <div class="col-sm-9">
                   ...
                   {{Form::textarea('question',$question->question_text,['class'=>'form-control','rows'=>5])}}
                   </div></div>
...
<div class="form-group no-margin" id="optionTemplate">
 ...
 @endif
                   ...
                   ?>
                    ...
                    {{Form::radio('multiple_selection',1,$qtny,['id'=>'multiple_selectiony'])}} 
                    {{Form::label('multiple_selectiony','Yes ')}}

                    {{Form::radio('multiple_selection',0,$qtnn,['id'=>'multiple_selectionn'])}} 
                    {{Form::label('multiple_selectionn','No ')}}
                   ...
                   ?>
                    ...
                    {{Form::radio('addother',1,$qtny,['id'=>'addothery'])}} 
                    {{Form::label('addothery','Yes ')}}

                    {{Form::radio('addother',0,$qtnn,['id'=>'addothern'])}} 
