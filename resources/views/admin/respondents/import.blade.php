    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-8 col-sm-offset-2">
                <h3 class="text-center">Import Respondents</h3>

                <ul class="nav nav-tabs">

                    <li class="active"><a data-toggle="tab" href="#add-import">Bulk Import</a></li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div id="add-import" class="tab-pane fade in  active">
                        @if (Session::get('msg'))

                            <div class="alert alert-danger import-process-error">
                                <a class="close" onclick="$('.alert').hide()">x</a>
                                @if (Session::get('msg') != 'Heading Mismatch line @ 1 . (p_email,r_fname,r_lname,r_email,r_type) Plz enter this format.')
                        ...
                        @endif
                        <form action="{{ URL::route('import_respondents') }}" class="form-horizontal" method="POST"
                            ...
                            <div class="instructions">
                                <div class="group-text-info pull-left col-sm-6">
                                    <p class="text-info">Upload .xls .xlsx file with following headers to update the
                                        participant list. <b>(p_email,r_fname,r_lname,r_email,r_type)</b></p>
                                ...
                                <p class="text-info col-sm-10">Download sample users <a
                                        href="{{ URL::route('respondent.download') }}" class="btn btn-primary"><i
                            ...
                            <div class="form-group col-sm-12" align="center">
                                <a href="{{ route('addusers.show', [$survey_id]) }}" class="btn btn-danger">Cancel</a>
