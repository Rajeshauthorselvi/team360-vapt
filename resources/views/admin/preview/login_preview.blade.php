...
<header>
   ...
   <div class="col-sm-3  img-responsive"> {{ HTML::image('storage/surveys/'.$left_logo,'') }}</div>
  <div class="col-sm-6 header_text">{!! $header_text !!}</div>
  <div  class="col-sm-3   img-responsive"> {{ HTML::image('storage/surveys/'.$right_logo,'') }}</div>
                   ...
                   <!-- <label for="password">Password: </label>-->
                    ...
                    <div class="form-group">
                        <!-- Button -->
                         ...
                         <button type="submit" href="#" class="btn btn-submit  " disabled><!--<i class="btn icon-btn-save btn-submit "></i>-->LOGIN</button>
                          ...
                          @if(Session::has('error'))
                            ...
                            <div class="panel-body">
                              {!! Form::open(['route' => 'reset_pass_index','Method'=>'POST','class'=>'form-horizontal','id'=>'reset-pass','name'=>'form']) !!}
                                    <div class="form-group">
                                        {{Form::text('resetemail',null,['class'=>'form-control input-lg','id'=>'','placeholder'=>'Email Address'])}}
                                    </div>
                                    <input class="btn btn-lg btn-primary btn-block" value="Send My Password" type="submit" disabled>
                              {!! Form::close() !!}
                            </div>
